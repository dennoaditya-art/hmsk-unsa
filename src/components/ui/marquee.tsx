export function Marquee({ text = "HMSK • WEBCRAFT • LAPTOPCARE • HOST & INVITE • UNSA • SISTEM KOMPUTER •" }: { text?: string }) {
  ...
  return (
    <div className="relative overflow-hidden border-y border-border bg-foreground py-2.5">
      <div className="flex animate-[marquee_22s_linear_infinite] whitespace-nowrap mono text-xs tracking-[0.18em] text-background/85">
