        ...
        <div className="relative mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
          ...
          <div className="mt-6 flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            ...
            <div className="rounded-2xl bg-card text-foreground px-5 py-4 lg:text-right border border-border">
              ...
              <p className="mono text-xs text-muted-foreground">2 berjalan • 1 segera • Dibina mentor</p>
            </div>
          </div>
        </div>
      </section>
          ...
          {prokers.map((p) => (
            <Card key={p.id} className="group border-border bg-card hover:border-primary/35 hover:shadow-lg transition will-change-transform hover:[transform:translateY(-4px)] overflow-hidden">
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <p className="mono text-xs font-semibold tracking-widest text-muted-foreground">{p.title}</p>
                ...
                <div className="mt-4 rounded-xl bg-background border border-border px-3 py-2 flex items-center gap-2">
